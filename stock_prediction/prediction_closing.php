...
<head>
    <meta charset="UTF-8">
    <title>Closing Price Prediction</title>
...
<script src="path-to/src/pluscharts.js"></script>
	...
	<!--<link href="style3.css" rel="stylesheet">--><style>
...
<div class="sidebar">
		...
		<br><br><br><br><br><br><br><br>
             <li><a href="predict1.php?stock=<?php echo $_GET["stock"]?>" id="top-link" class="skel-panels-ignoreHref"><span class="icon icon-th">Opening Price Prediction</span></a></li>
...
?></h4>
                   <h3> Next Day Closing Price Prediction For <?php echo $_GET["stock"];?> : -</h3>
                </div>
            </div>
...
if($stmt = $connection->query("SELECT x,y FROM piechart")){
