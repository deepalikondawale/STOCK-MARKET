...
$returnrate=$annualRate/100;

$inv=(1+$returnrate);
$v=pow($inv,$years);
$futureValue=$invesmet*$v;

$invesmet_amonut=$invesmet;

$est_rtn=$futureValue-$invesmet;
endif;
...
<div class="sidebar">
        ...
        <ul>
			<br><br><br><br><br><br><br><br>
             <li><a href="../calculator/sip.php" id="top-link" class="skel-panels-ignoreHref"><span class="icon icon-th">SIP Calculator</span></a></li>
                <li><a href="#" id="top-link" class="skel-panels-ignoreHref"><span class="icon icon-th">LumpSum Calculator</span></a></li>
 	...
 	<div class="card-body">
 		<form action="" method="post">
 			<div class="form-group">
 				<input type="number" name="invesmet" placeholder="Investment Amount" required="" class="form-control" value="<?php if(!empty($invesmet)):echo $invesmet; endif;?>">
 			</div>
 			<div class="form-group">
 				<input type="number"min="1" max="30" step="0.1" name="return_rate" placeholder="Expected Return Rate" required="" class="form-control" 
 	...
 	<div class="card-body bg-white">
 		<table class="table table-bordered table-hover">
 			<tr>
 				...
 				<th>&#8377; <?php echo number_format(@$invesmet);?></th>
 			</tr>
 			<tr>
 				<th>Est. Returns</th>
